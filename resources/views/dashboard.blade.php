...
@section('contenido')
    <div class="flex justify-center">
        <div class="w-full md:w-8/12 lg:w-6/12 flex flex-col items-center md:flex-row">
            ...
            <div 
                class="md:w-8/12 lg:6/12 px-5 flex flex-col items-center md:justify-items-center md:items-start py-10 md:py-10"
            >
                <div class="flex  items-center gap-2">
                    <p class="text-gray-700 text-2xl capitalize">
                        {{ $user->username }}
                    </p>
